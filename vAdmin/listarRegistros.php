                            ...
                            ?>
                                    ...
                                    <td id="accion">
                                        <div class="btn-group" role="group">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                <li>
                                                    <a class="dropdown-item" role="button" onclick="accionAlta();">
                                                        Dar de alta
                                                    </a>
                                                </li>
                                                <li>
                                ...
                                <script>
                                    function accionAlta() {
                                        ...
                                        Swal.fire({
                                            title: 'Aviso',
                                            text: "Dar de alta a " + nombre + ' ' + apellido,
                                            icon: 'warning',
                                            ...
                                            if (result.isConfirmed) {
                                                window.location = '../controlador/c_altaUsuario.php?dni=<?php echo $solicitud[0]; ?>'
                                            }
                                        })
                                    }
                                    ...
                                    function accionEliminar() {
                                        ...
                                        Swal.fire({
                                            title: 'Aviso',
                                            text: "Eliminar a " + nombre + ' ' + apellido,
                                            icon: 'warning',
                                            showCancelButton: true,
                                            confirmButtonColor: '#3085d6',
                                            cancelButtonColor: '#d33',
                                            ...
                                            if (result.isConfirmed) {
                                                window.location = '../controlador/c_eliminarSolicitud.php?dni=<?php echo $solicitud[0]; ?>'
                                            }
                                        })
                                    }
                                </script>
